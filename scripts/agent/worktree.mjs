...
import { git, parseArgs, readJson, root, worktreeRegistryPath, writeJson } from "./common.mjs";
...
if (command === "list") {
  ...
  git(["worktree", "add", "-b", branch, path, "main"], { stdio: "inherit" });
  ...
  git(["worktree", "remove", entry.path], { stdio: "inherit" });
