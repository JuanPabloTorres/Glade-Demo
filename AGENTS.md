...
3. Depend on provider protocols and only on repository abstractions that actually exist. The current backend is mostly stateless; persistence requires an ADR and implementation.
